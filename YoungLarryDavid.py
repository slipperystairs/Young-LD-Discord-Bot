...
async def random(ctx):
    ...
    await client.say(random_lyrics)
...
async def snoop(ctx):
    ...
    await client.say(snoop_dogg_lyrics)
...
async def triple6(ctx):
    ...
    await client.say(three_six_lyrics)
...
async def pat(ctx):
    ...
    await client.say(project_pat_lyrics)
...
async def wutang(ctx):
    ...
    await client.say(wu_tang_lyrics)
...
async def biggie(ctx):
    ...
    await client.say(biggie_lyrics)
...
async def droctagon(ctx):
    ...
    await client.say(doc_oct_lyrics)
...
async def eminem(ctx):
    ...
    await client.say(eminem_lyrics)
...
async def gibbs(ctx):
    ...
    await client.say(freddie_gibbs_lyrics)
...
async def outkast(ctx):
    ...
    await client.say(outkast_lyrics)
